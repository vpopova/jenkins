	...
	grunt.initConfig({
		...
		less: {
			development: {
                ...
                files1: {
                    'app/assets/css/ie.css': [
                        'app/assets/css/reset.less',
                        'app/assets/css/ie.less'
                    ]
                }
			}
		},
		...
		concat: {
			...
			js1: {
				src: [
                    'app/assets/js/jquery-1.11.1.js',
                    'app/assets/js/css_browser_selector.js',
					'app/assets/js/mc-validate.js',
					'app/assets/js/wow.js',
                    'app/assets/js/menu.js',
                    'app/assets/js/cookie.js',
                    'app/assets/js/modal.js',
                    'app/assets/js/index.js'
                ],
				dest: 'app/assets/js/concat/concat-index.js'
			},
            js2: {
                src: [
                    'app/assets/js/jquery-1.11.1.js',
                ...
                dest: 'app/assets/js/concat/concat.js'
            }
		},
        jshint: {
            src: [
		...
		cssmin: {
			combine: {
				files: {
					'dist/assets/css/main.css': ['app/assets/css/main.css', 'app/assets/css/animate.css'],
                    'dist/assets/css/ie.css': ['app/assets/css/ie.css']
				}
			}
		},
		...
		uglify: {
			...
			js: {
				files: {
					'dist/assets/js/concat/concat.js': ['app/assets/js/concat/concat.js'],
                    'dist/assets/js/concat/concat-index.js': ['app/assets/js/concat/concat-index.js']
				}
			}
		},
			...
			dist: {
				files: [{
					...
					src: [
                        ...
                        'assets/images/logo-tradeBird.svg',
						'assets/fonts/{,*/}*.*',
                        'assets/video/*.*'
                    ]
                }]
